...
<head>
    ...
    <!-- ==== Document Title ==== -->
    <title>Kaarigar online - your online service partner | Services</title>
    ...
    <link href="assets/css/fakeLoader.min.css" rel="stylesheet">
    ...
    <link href="assets/css/colors/color-10.css" rel="stylesheet" id="changeColorScheme">
...
<body>
    ...
    <div class="wrapper">
            ...
            <div class="header--topbar bg--color-dark">
                <div class="container">
                    ...
                    <ul class="nav links float--left">
                        ...
                        <li class="show-xxs"><a href="#"><i class="fa fa-map-marker"></i>&nbsp; <span id="loc">Location</span></a></li>
                    </ul>
            ...
            <div class="header--navbar-top hidden-xxs">
                <div class="container">
                    ...
                    <div class="logo float--left">
                        <div class="vc--parent">
                            <div class="vc--child">
                                <a href="index.html"><img src="assets/images/logo.png" alt="Kaarigar Logo" data-rjs="2"></a>
                            </div>
                        </div>
                    </div>
                    <!-- Logo End -->
                    ...
                    <div class="float--right">
                        ...
                        <div class="header--navbar-top-btn float--left">
                            <div class="vc--parent">
                                <div class="vc--child">
                                    <a href="index.html#appointment" class="btn btn-default">Book Service</a>
                                </div>
                            </div>
                        </div>
                ...
                <div class="container">
                    ...
                    <div id="headerNav" class="navbar-collapse collapse float--left">
                        ...
                        <ul class="header--nav-links nav navbar-nav font--secondary">
                            <li class="header-svc">
                                <a href="index.html">
                                    <img src="assets/images/services-img/saw-up.png" alt="Carpenter" class="sv-img">
                                    &nbsp;
                            ...
                            <li class="header-svc">
                                <a href="index.html">
                                    <img src="assets/images/services-img/air-conditioner.png" class="sv-img">
                                    &nbsp;
                                    <span>AC repair</span>
                                </a>
                            </li>
                            <li class="header-svc">
                                <a href="index.html">
                                    <img src="assets/images/services-img/electricity.png" alt="Carpenter" class="sv-img">
                                    &nbsp;
                            ...
                            <li class="header-svc">
                                <a href="index.html">
                                    <img src="assets/images/services-img/wrench.png" alt="Carpenter" class="sv-img">
                                    &nbsp;
                                    <span>Plumber</span>
                                </a>
                            </li>
                            <li class="header-svc">
                                <a href="index.html">
                                    <img src="assets/images/services-img/brush.png" alt="Carpenter" class="sv-img">
                                    &nbsp;
                                    <span>Painter</span>
                                </a>
                            </li>
        ...
        <div class="page-header--section text-center">
            <!-- Page Title Start -->
            <div class="page--title pd--130-0" data-bg-img="assets/images/page-header-img.jpg">
                <div class="container">
                ...
                <div class="row AdjustRow">
                    <div class="col-md-4 col-sm-6 col-xs-12">
                        ...
                        <div class="extra-service--item">
                            <img src="assets/images/extra-services-img/extra-service-item-01.jpg" alt="" data-rjs="2">

                            <div class="extra-service--info">
                                <div class="extra-service--info-content">
                                    <div class="title">
                                        <h2 class="h4">
                                            <img src="assets/images/services-img/wrench.png" alt="plumber" class="sv-img">
                                            &nbsp;
                    ...
                    <div class="col-md-4 col-sm-6 col-xs-12">
                        <!-- Extra Service Item Start -->
                        <div class="extra-service--item">
                            <img src="assets/images/extra-services-img/extra-service-item-02.jpg" alt="" data-rjs="2">

                            <div class="extra-service--info">
                                <div class="extra-service--info-content">
                                    <div class="title">
                                        <h2 class="h4">
                                            <img src="assets/images/services-img/electricity.png" alt="Electrician" class="sv-img">
                                            &nbsp;
                    ...
                    <div class="col-md-4 col-sm-6 col-xs-12">
                        <!-- Extra Service Item Start -->
                        <div class="extra-service--item">
                            <img src="assets/images/extra-services-img/extra-service-item-03.jpg" alt="" data-rjs="2">

                            <div class="extra-service--info">
                                <div class="extra-service--info-content">
                                    <div class="title">
                                        <h2 class="h4">
                                            <img src="assets/images/services-img/air-conditioner.png" alt="AC repair" class="sv-img">
                                            &nbsp;
                                            <a href="#">AC repair</a>
                                        </h2>
                                    </div>
                    ...
                    <div class="col-md-4 col-sm-6 col-xs-12">
                        <!-- Extra Service Item Start -->
                        <div class="extra-service--item">
                            <img src="assets/images/extra-services-img/extra-service-item-04.jpg" alt="" data-rjs="2">
                    ...
                    <div class="col-md-4 col-sm-6 col-xs-12">
                        <!-- Extra Service Item Start -->
                        <div class="extra-service--item">
                            <img src="assets/images/extra-services-img/extra-service-item-05.jpg" alt="" data-rjs="2">

                            <div class="extra-service--info">
                                <div class="extra-service--info-content">
                                    <div class="title">
                                        <h2 class="h4">
                                            <img src="assets/images/services-img/brush.png" alt="Painter" class="sv-img">
                                            &nbsp;
                                            <a href="#">Painter</a>
                                        </h2>
                                    </div>
                    ...
                    <div class="col-md-4 col-sm-6 col-xs-12">
                        <!-- Extra Service Item Start -->
                        <div class="extra-service--item">
                            <img src="assets/images/extra-services-img/extra-service-item-06.jpg" alt="">

                            <div class="extra-service--info">
                                <div class="extra-service--info-content">
                                    <div class="title">
                                        <h2 class="h4">
                                            <img src="assets/images/services-img/hair-cut.png" alt="hair cut" class="sv-img">
                                            &nbsp;
                    ...
                    <div class="col-md-4 col-sm-6 col-xs-12">
                        <!-- Extra Service Item Start -->
                        <div class="extra-service--item">
                            <img src="assets/images/extra-services-img/extra-service-item-07.jpg" alt="">

                            <div class="extra-service--info">
                                <div class="extra-service--info-content">
                                    <div class="title">
                                        <h2 class="h4">
                                            <img src="assets/images/services-img/car-repair.png" alt="car repair" class="sv-img">
                                            &nbsp;
                                            <a href="#">Car repair</a>
                                    </div>
                ...
                <div class="row reset--gutter">
                    <div class="col-md-3 bg--color-theme bg--overlay">
                        ...
                        <div class="footer--about">
                            <div class="logo">
                                <img src="assets/images/footer-logo.png" alt="" data-rjs="2">
                            </div>
                            ...
                            <div class="link">
                                <a href="#">Read More<i class="fa flm fa-angle-double-right"></i></a>
                            </div>
                    ...
                    <div class="col-md-9">
                        ...
                        <div class="footer--widgets row">
                            ...
                            <div class="footer--widget col-md-4">
                                ...
                                <div class="links--widget">
                                    <ul class="nav">
                                        <li><a href="#"><i class="fa fa-link"></i>New registration</a></li>
