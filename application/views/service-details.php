...
<head>
    ...
    <!-- ==== Document Title ==== -->
    <title>Kaarigar online - your online service partner | Plumber service</title>
    ...
    <!-- ==== Checkbox Plugin ==== -->
    <link href="assets/css/simsCheckbox.css" rel="stylesheet">
...
<body>
    ...
    <div class="wrapper">
            ...
            <div class="header--topbar bg--color-dark">
                <div class="container">
                    ...
                    <ul class="nav links float--left">
                        ...
                        <li class="hidden-xxs"><a href="profile.html"><i class="fa fa-user"></i>&nbsp; Profile</a></li>
        ...
        <div class="page-header--section text-center">
            ...
            <div class="page--title pd--130-0" data-bg-img="assets/images/page-header-img.jpg">
                <div class="container">
                    <h1 class="h1 text-left">Plumber</h1>
                </div>
            </div>
            <!-- Page Title End -->
            ...
            <div class="page--breadcrumb font--secondary">
                <div class="container">
                    <ul class="breadcrumb text-left">
                        ...
                        <li class="active"><span>Plumber</span></li>
                    </ul>
                </div>
            </div>
            <!-- Page Breadcrumb End -->
            ...
            <div class="container">
                <div class="row">
                    <div class="col-sm-8 mb--3">
                        <h4 class="h3 mb--3">
                            <img src="assets/images/services-img/wrench.png" alt="Carpenter" class="sv-img"> &nbsp; Plumber service
                        </h4>  
                        <hr> 
                        <p class="font-16">
                        ...
                        <div class="nav-links--widget bg--color-lightgray pb--60">
                            ...
                            <form action="" class="ml--3 mr--3">
                                <ul class="demo service-select">
                                    <li data-check-id="1">Tap change
                                        <br>
                                        <small>( Charges : 150/- )</small>
                                    </li>
                                    <input type="checkbox" data-check-id="1" name="1" hidden>

                                    <li data-check-id="2">Leakage/Seapage resolution</li>
                                    <input type="checkbox" data-check-id="2" name="2" hidden>

                                    <li data-check-id="3">Water tank resolution</li>
                                    <input type="checkbox" data-check-id="3" name="3" hidden>

                                    <li data-check-id="4">New Connection</li>
                                    <input type="checkbox" data-check-id="4" name="4" hidden>
    ...
    <!-- ==== chechbox Plugin ==== -->
    <script src="assets/js/simsCheckbox.js"></script>
